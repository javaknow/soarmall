...
import com.metoo.foundation.domain.query.ArticleClassQueryObject;
...
public class ArticleClassManageAction {
	...
	public ModelAndView add(HttpServletRequest request,
		...
		/*List<GoodsClass> goodsclass =null;
		if(article_id != null && !article_id.equals("")){
			Map params = new HashMap();
			params.put("obj.article_id", article_id);
			goodsclass = this.goodsClassService.query(
					"select obj from GoodsClass obj where obj.parent.id is null", params,
					-1, -1);
		}
