...
public class GoodsClassManageAction {
	 ...
	 * goodsClass  更新管理
	 */
	//@SecurityMapping(title = "商品分类更新列表", value = "/admin/goods_class_ulist.htm*", rtype = "admin", rname = "分类管理", rcode = "goods_class", rgroup = "商品")
...
//	@SecurityMapping(title = "商品分类查看", value = "/admin/goods_class_look.htm*", rtype = "admin", rname = "分类管理", rcode = "goods_class", rgroup = "商品")
	...
	//@SecurityMapping(title = "商品分类更新", value = "/admin/goods_class_update.htm*", rtype = "admin", rname = "分类管理", rcode = "goods_class", rgroup = "商品")
		...
		if (gbs_ids != null && !gbs_ids.equals("")) {
			...
			for (String gb_id : gb_ids) {
				if (gb_id != null && !gb_id.equals("")) {
					...
					System.out.println(gb.getBrandLogo().getPath());
					map_temp.put("imgName", gb.getBrandLogo().getName());
					System.out.println(gb.getBrandLogo().getName());
