...
import com.metoo.foundation.domain.query.SysLogQueryObject;
...
import com.metoo.manage.buyer.action.AccountBuyerAction;
import com.metoo.manage.buyer.action.AddressBuyerAction;
import com.metoo.manage.buyer.action.BaseBuyerAction;
import com.metoo.manage.buyer.action.ComplaintBuyerAction;
import com.metoo.manage.buyer.action.ConsultBuyerAction;
import com.metoo.manage.buyer.action.CouponBuyerAction;
import com.metoo.manage.buyer.action.EvaluateBuyerAction;
import com.metoo.manage.buyer.action.FavoriteBuyerAction;
import com.metoo.manage.buyer.action.FootPointBuyerAction;
import com.metoo.manage.buyer.action.FreeBuyerAction;
import com.metoo.manage.buyer.action.GroupBuyerAction;
import com.metoo.manage.buyer.action.IntegralOrderBuyerAction;
import com.metoo.manage.buyer.action.MessageBuyerAction;
import com.metoo.manage.buyer.action.OrderBuyerAction;
import com.metoo.manage.buyer.action.PredepositBuyerAction;
import com.metoo.manage.buyer.action.PredepositCashBuyerAction;
import com.metoo.manage.buyer.action.RechargeCardBuyerAction;
import com.metoo.manage.delivery.action.DeliveryApplyAction;
import com.metoo.manage.delivery.action.DeliveryIndexAction;
import com.metoo.manage.seller.action.ActivitySellerAction;
import com.metoo.manage.seller.action.AdvertSellerAction;
import com.metoo.manage.seller.action.AlbumSellerAction;
import com.metoo.manage.seller.action.BaseSellerAction;
import com.metoo.manage.seller.action.BuyGiftSellerAction;
import com.metoo.manage.seller.action.CombinSellerAction;
import com.metoo.manage.seller.action.ComplaintSellerAction;
import com.metoo.manage.seller.action.ConsultSellerAction;
import com.metoo.manage.seller.action.CouponSellerAction;
import com.metoo.manage.seller.action.EnoughReduceSellerAction;
import com.metoo.manage.seller.action.EvaluateSellerAction;
import com.metoo.manage.seller.action.ExpressCompanyCommonSellerAction;
import com.metoo.manage.seller.action.FreeGoodsSellerAction;
import com.metoo.manage.seller.action.GoldSellerAction;
import com.metoo.manage.seller.action.GoodsBrandSellerAction;
import com.metoo.manage.seller.action.GoodsClassSellerAction;
import com.metoo.manage.seller.action.GoodsFormatSellerAction;
import com.metoo.manage.seller.action.GoodsSellerAction;
import com.metoo.manage.seller.action.GoodsSpecSellerAction;
import com.metoo.manage.seller.action.GoodsStatSellerAction;
import com.metoo.manage.seller.action.GroupSellerAction;
import com.metoo.manage.seller.action.OrderSellerAction;
import com.metoo.manage.seller.action.PayoffLogsellerAction;
import com.metoo.manage.seller.action.ReturnSellerAction;
import com.metoo.manage.seller.action.SellerCrmManageAction;
import com.metoo.manage.seller.action.ShipAddressSellerAction;
import com.metoo.manage.seller.action.SmsSellerAction;
import com.metoo.manage.seller.action.StoreAdjustApplyAction;
import com.metoo.manage.seller.action.StoreDecorateSellerAction;
import com.metoo.manage.seller.action.StoreNavSellerAction;
import com.metoo.manage.seller.action.StoreNoticeAction;
import com.metoo.manage.seller.action.StoreSellerAction;
import com.metoo.manage.seller.action.StoreStatSellerAction;
import com.metoo.manage.seller.action.SubAccountSellerAction;
import com.metoo.manage.seller.action.TaobaoSellerAction;
import com.metoo.manage.seller.action.TransportSellerAction;
import com.metoo.manage.seller.action.WaterMarkSellerAction;
import com.metoo.manage.seller.action.ZtcSellerAction;
import com.metoo.metooapi.manage.buyer.action.MetooAccountBuyerAction;
import com.metoo.module.app.manage.admin.action.AppManageAction;
import com.metoo.module.chatting.manage.admin.action.PlatChattingManageAction;
import com.metoo.module.chatting.manage.seller.action.StoreChattingViewAction;
import com.metoo.module.sns.manage.admin.action.SnsManageAction;
import com.metoo.module.sns.manage.buyer.action.SnsBuyerAction;
import com.metoo.module.sns.manage.buyer.action.SnsBuyerDynamicAction;
import com.metoo.module.sns.view.action.SnsOtherUserViewAction;
import com.metoo.module.sns.view.action.SnsUserShareAction;
import com.metoo.module.weixin.manage.admin.action.WeixinManageAction;
import com.metoo.module.weixin.manage.buyer.action.WeixinUserAddressAction;
import com.metoo.module.weixin.manage.buyer.action.WeixinUserCenterAction;
import com.metoo.module.weixin.manage.buyer.action.WeixinUserComplaintAction;
import com.metoo.module.weixin.manage.buyer.action.WeixinUserFreeAction;
import com.metoo.module.weixin.manage.buyer.action.WeixinUserGroupAction;
import com.metoo.module.weixin.manage.buyer.action.WeixinUserGroupInfoAction;
import com.metoo.module.weixin.manage.buyer.action.WeixinUserIntegralAction;
import com.metoo.module.weixin.manage.buyer.action.WeixinUserOrderAction;
import com.metoo.module.weixin.view.action.WeixinCartViewAction;
import com.metoo.module.weixin.view.action.WeixinFreeGoodsViewAction;
import com.metoo.module.weixin.view.action.WeixinGroupViewAction;
import com.metoo.module.weixin.view.action.WeixinIntegralViewAction;
import com.metoo.view.web.action.CartViewAction;
import com.metoo.view.web.action.FreeViewAction;
import com.metoo.view.web.action.IntegralViewAction;
import com.metoo.view.web.action.RechargeAction;
import com.metoo.view.web.action.SellerApplyAction;
 ...
 * 
 * <p>
 * Company: 觅通网之商科技有限公司 ebuyair.metoo-souq.com
 * </p>
 * 
 * @author erikzhang
 * 
...
public class AdminManageAction implements ServletContextAware {
	...
	public String init_role() {
		...
		if (current_user != null
			...
			clzs.add(MetooAccountBuyerAction.class);
			// wap买家权限
