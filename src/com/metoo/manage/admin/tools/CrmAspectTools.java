...
import com.metoo.foundation.service.ICustomerRelManaService;
...
public class CrmAspectTools {
	...
	private static final String ORDER_AOP = "execution(* com.metoo.foundation.service.impl.OrderFormServiceImpl.*(..))";
	private static final String CONSULT_AOP = "execution(* com.metoo.foundation.service.impl.ConsultServiceImpl.*(..))";
	private static final String FAVORITE_AOP = "execution(* com.metoo.foundation.service.impl.FavoriteServiceImpl.*(..))";
