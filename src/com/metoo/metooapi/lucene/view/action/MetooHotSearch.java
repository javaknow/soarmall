package com.metoo.metooapi.lucene.view.action;
...
public class MetooHotSearch {
	...
	@RequestMapping("/hot_search.json")
	@ResponseBody
...
/*		
	...
	/*	mv.addObject("keyword", keyword);
		...
		if(CommUtil.isNotNull(seachmap)){
			result = new Result(0,"查询成功",seachmap);
		}else{
