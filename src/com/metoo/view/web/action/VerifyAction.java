...
public class VerifyAction {
	...
	@RequestMapping("/query_username.htm")
	public void query_username(HttpServletRequest request,
			HttpServletResponse response, String userName) {
		String role = null;
		Map params = new HashMap();
		params.put("userName", userName);
		List<User> users = this.userService
				.query("select obj from User obj where (obj.userName=:userName or obj.mobile=:userName or obj.email=:userName)",
						params, -1, -1);
		for(User user:users){
